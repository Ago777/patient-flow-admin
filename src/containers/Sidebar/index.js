...
class Sidebar extends Component {
    ...
    setSelectedLiActive = () => {
        ...
        this.setState({activeRoute: path.split('/')[2]})
    }
    ...
    render() {
        return (
            <div className="sidebar">
                            ...
                            <Nav vertical className="list-unstyled">
                                <NavItem
                                    className={classnames({
                                        ...
                                        active: (this.state.activeRoute === 'dashboard')
                                    })}
                                >
                                    <NavLink
                                        to="/app/dashboard"
                                        onClick={() => this.setState({activeRoute: 'dashboard'})}
                                        // onClick={e => this.openSubMenu(e, "dashboard")}
                                    >
                                ...
                                >
                                    <NavLink
                                        to="/app/appointments"
                                        onClick={() => this.setState({activeRoute: 'appointments'})}
                                ...
                                <NavItem
                                    className={classnames({
                                        active: (this.state.activeRoute === 'reminders')
                                    })}
                                >
                                    <NavLink
                                        to="/app/reminders"
                                        onClick={() => this.setState({activeRoute: 'reminders'})}
                                ...
                                <NavItem
                                    className={classnames({
                                        active: (this.state.activeRoute === 'calendar')
                                    })}
                                >
                                    <NavLink
                                        to="/app/calendar"
                                        onClick={() => this.setState({activeRoute: 'calendar'})}
                                ...
                                >
                                    <NavLink
                                        to="/app/patients"
                                        onClick={() => this.setState({activeRoute: 'patients'})}
                                ...
                                <NavItem
                                    className={classnames({
                                        active: (this.state.activeRoute === 'phones')
                                    })}
                                >
                                    <NavLink
                                        to="/app/phones"
                                        onClick={() => this.setState({activeRoute: 'phones'})}
                                ...
                                <NavItem
                                    className={classnames({
                                        active: (this.state.activeRoute === 'reviews')
                                    })}
                                >
                                    <NavLink
                                        to="/app/reviews"
                                        onClick={() => this.setState({activeRoute: 'reviews'})}
                                        // onClick={e => this.openSubMenu(e, "reviews")}
                                    >
                                ...
                                <NavItem
                                    className={classnames({
                                        active: (this.state.activeRoute === 'seo')
                                    })}
                                >
                                    <NavLink
                                        to="/app/seo"
                                        onClick={() => this.setState({activeRoute: 'seo'})}
                                        // onClick={e => this.openSubMenu(e, "SEO")}
                                    >
                                ...
                                <NavItem
                                    className={classnames({
                                        active: (this.state.activeRoute === 'listings')
                                    })}
                                >
                                    <NavLink
                                        to="/app/listings"
                                        onClick={() => this.setState({activeRoute: 'listings'})}
                ...
                {/*>*/}
                {/*<NavItem>*/}
                {/*<a href="/multipage-home" target="_blank"><i*/}
                {/*className="simple-icon-docs"/>{" "}<IntlMessages id="menu.multipage-home"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/singlepage-home" target="_blank"><i*/}
                {/*className="simple-icon-doc"/>{" "}<IntlMessages id="menu.singlepage-home"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/about" target="_blank"><i className="simple-icon-info"/>{" "}<IntlMessages*/}
                {/*id="menu.about"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/auth-login" target="_blank"><i*/}
                {/*className="simple-icon-user-following"/>{" "}<IntlMessages*/}
                {/*id="menu.auth-login"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/auth-register" target="_blank"><i*/}
                {/*className="simple-icon-user-follow"/>{" "}<IntlMessages*/}
                {/*id="menu.auth-register"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/blog" target="_blank"><i*/}
                {/*className="simple-icon-bubbles"/>{" "}<IntlMessages id="menu.blog"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/blog-detail" target="_blank"><i*/}
                {/*className="simple-icon-bubble"/>{" "}<IntlMessages id="menu.blog-detail"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/careers" target="_blank"><i*/}
                {/*className="simple-icon-people"/>{" "}<IntlMessages id="menu.careers"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/confirmation" target="_blank"><i*/}
                {/*className="simple-icon-check"/>{" "}<IntlMessages id="menu.confirmation"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/contact" target="_blank"><i*/}
                {/*className="simple-icon-phone"/>{" "}<IntlMessages id="menu.contact"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/content" target="_blank"><i*/}
                {/*className="simple-icon-book-open"/>{" "}<IntlMessages id="menu.content"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/docs" target="_blank"><i*/}
                {/*className="simple-icon-notebook"/>{" "}<IntlMessages id="menu.docs"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/features" target="_blank"><i*/}
                {/*className="simple-icon-chemistry"/>{" "}<IntlMessages id="menu.features"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/prices" target="_blank"><i*/}
                {/*className="simple-icon-wallet"/>{" "}<IntlMessages id="menu.prices"/></a>*/}
                {/*</NavItem>*/}
                {/*<NavItem>*/}
                {/*<a href="/videos" target="_blank"><i*/}
                {/*className="simple-icon-film"/>{" "}<IntlMessages id="menu.videos"/></a>*/}
                {/*</NavItem>*/}
                {/*</Nav>*/}
